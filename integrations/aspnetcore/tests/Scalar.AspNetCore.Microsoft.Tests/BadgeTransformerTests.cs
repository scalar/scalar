...
public class BadgeTransformerTests(WebApplicationFactory<Program> factory) : IClassFixture<WebApplicationFactory<Program>>
{
    [Fact]
    public async Task BadgeTransformer_ShouldAddBadges()
    {
        // Arrange
