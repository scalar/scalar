...
using Scalar.AspNetCore.Microsoft;
...
public static class ServiceCollectionExtensions
{
    ...
    /// <param name="configureOptions">An action to configure the <see cref="ScalarMicrosoftOptions" />.</param>
    /// <returns>The <see cref="IServiceCollection" /> so that additional calls can be chained.</returns>
    /// <remarks>
    /// This method is only available on .NET 10.0 or greater.
    ...
    /// </remarks>
    public static IServiceCollection AddScalarServices(this IServiceCollection services, Action<ScalarMicrosoftOptions>? configureOptions = null)
    {
