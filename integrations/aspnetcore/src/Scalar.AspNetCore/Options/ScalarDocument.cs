...
/// <param name="OpenApiRoutePattern">The optional OpenAPI route pattern of the document.</param>
...
public sealed record ScalarDocument(string Name, string? Title = null, string? OpenApiRoutePattern = null);