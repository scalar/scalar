...
public static class ScalarOptionsExtensions
{
    ...
    /// <param name="pattern">Optional route pattern for the OpenAPI document. If not provided, the <see cref="ScalarOptions.OpenApiRoutePattern"/> will be used. The pattern can include the '{documentName}' placeholder which will be replaced with the document name.</param>
    /// <remarks>
    ...
    /// </remarks>
    public static ScalarOptions AddDocument(this ScalarOptions options, string documentName, string? title = null, string? pattern = null)
    {
        options.Documents.Add(new ScalarDocument(documentName, title, pattern));
        return options;
    }
