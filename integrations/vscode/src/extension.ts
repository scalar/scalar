...
<head>
    ...
    <style>
        ...
        .light-mode {
            --scalar-color-1: var(--vscode-foreground, #121212);
            --scalar-color-2: var(--vscode-descriptionForeground, rgba(0, 0, 0, 0.6));
            --scalar-color-3: var(--vscode-textSeparator-foreground, rgba(0, 0, 0, 0.4));
        ...
        .dark-mode {
            --scalar-color-1: var(--vscode-foreground, rgba(255, 255, 255, 0.81));
            --scalar-color-2: var(--vscode-descriptionForeground, rgba(255, 255, 255, 0.443));
            --scalar-color-3: var(--vscode-textSeparator-foreground, rgba(255, 255, 255, 0.282));
