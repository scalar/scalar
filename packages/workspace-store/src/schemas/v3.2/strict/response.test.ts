...
describe('response', () => {
  ...
  describe('value checking', () => {
    ...
    it('accepts a response without a description (optional as of OpenAPI 3.2)', () => {
      expect(Value.Check(ResponseObjectSchema, {})).toBe(true)
    })

    it('parses a response summary (OpenAPI 3.2)', () => {
      const validInput = {
        summary: 'The pet was created',
        description: 'Success response',
      }
