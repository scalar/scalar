...
import { ExampleObjectRef, MediaTypeObjectRef, SchemaObjectRef } from '@/schemas/v3.2/strict/ref-definitions'
import { type ReferenceType, reference } from '@/schemas/v3.2/strict/reference'
