...
import { ComponentsObjectSchema, OpenAPIDocumentSchema } from '@/schemas/v3.2/strict/openapi-document'
...
describe('should correctly cast/default values to make the input schema compliant', () => {
  ...
  it('should pass strict validation after coerce values', { timeout: 200_000 }, async () => {
