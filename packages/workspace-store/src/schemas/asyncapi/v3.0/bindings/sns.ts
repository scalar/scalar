 ...
 */
const OrderingSchemaDefinition = Type.Object({
...
export const SnsChannelBindingSchemaDefinition = Type.Object({
  ...
  ordering: Type.Optional(OrderingSchemaDefinition),
 ...
 */
const DeliveryPolicySchemaDefinition = Type.Object({
 ...
 */
const ConsumerSchemaDefinition = Type.Object({
  ...
  endpoint: IdentifierSchemaDefinition,
  ...
  deliveryPolicy: Type.Optional(DeliveryPolicySchemaDefinition),
...
export const SnsOperationBindingSchemaDefinition = Type.Object({
  ...
  topic: Type.Optional(IdentifierSchemaDefinition),
  /** The protocols that listen to this topic and their endpoints. */
  consumers: Type.Optional(Type.Array(ConsumerSchemaDefinition)),
