  ...
  describe("value checking", () => {
    describe("TraversedDescriptionSchemaDefinition", () => {
      it("parses valid description entry correctly", () => {
        ...
        expect(Value.Check(TraversedDescriptionSchemaDefinition, result)).toBe(
          true,
        );
      });
      ...
      it("rejects invalid description entry", () => {
        ...
        expect(
          Value.Check(TraversedDescriptionSchemaDefinition, invalidInput),
        ).toBe(false);
      });
    });
    ...
    describe("TraversedOperationSchemaDefinition", () => {
      it("parses valid operation entry correctly", () => {
        ...
        expect(result).toEqual(validInput);
        expect(Value.Check(TraversedOperationSchemaDefinition, result)).toBe(
          true,
        );
      });
      ...
      it("rejects operation entry with invalid HTTP method", () => {
        ...
        expect(
          Value.Check(TraversedOperationSchemaDefinition, invalidInput),
        ).toBe(false);
      });
    });
    ...
    describe("TraversedSchemaSchemaDefinition", () => {
      ...
      it("rejects schema entry with wrong type", () => {
        ...
        expect(Value.Check(TraversedSchemaSchemaDefinition, invalidInput)).toBe(
          false,
        );
      });
    });
    ...
    describe("TraversedWebhookSchemaDefinition", () => {
      it("parses valid webhook entry correctly", () => {
        ...
        expect(result).toEqual(validInput);
        expect(Value.Check(TraversedWebhookSchemaDefinition, result)).toBe(
          true,
        );
      });
    ...
    describe("TraversedEntrySchemaDefinition (union)", () => {
      ...
      it("rejects invalid entry types", () => {
        ...
        expect(Value.Check(TraversedEntrySchemaDefinition, invalidEntry)).toBe(
          false,
        );
      });

      it("rejects non-object input", () => {
        expect(Value.Check(TraversedEntrySchemaDefinition, "string")).toBe(
          false,
        );
        ...
        expect(Value.Check(TraversedEntrySchemaDefinition, undefined)).toBe(
          false,
        );
      });
    });
