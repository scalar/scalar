...
import { CallbackObjectSchema } from '@/schemas/v3.1/strict/callback'

export const OperationObjectBaseSchema = Type.Object({
...
export const OperationObjectWithoutCallbackSchema = Type.Union([OperationObjectBaseSchema, ReferenceObjectSchema])

export const OperationObjectSchema = Type.Union([
  Type.Intersect([
    OperationObjectBaseSchema,
    Type.Object({
      /** A map of possible out-of band callbacks related to the parent operation. The key is a unique identifier for the Callback Object. Each value in the map is a Callback Object that describes a request that may be initiated by the API provider and the expected responses. */
      callbacks: Type.Record(Type.String(), Type.Union([CallbackObjectSchema, ReferenceObjectSchema])),
    }),
  ]),
  ReferenceObjectSchema,
])

export type OperationObject = Static<typeof OperationObjectWithoutCallbackSchema>
