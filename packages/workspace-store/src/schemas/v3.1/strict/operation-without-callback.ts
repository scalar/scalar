...
export const OperationObjectWithoutCallbackSchema = Type.Union([
  Type.Object({
...
export type OperationObjectWithoutCallback = Static<typeof OperationObjectWithoutCallbackSchema>
