...
export const PathItemObjectSchema = Type.Object({
  ...
  get: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a PUT operation on this path. */
  put: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a POST operation on this path. */
  post: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a DELETE operation on this path. */
  delete: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a PATCH operation on this path. */
  patch: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a CONNECT operation on this path. */
  connect: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a OPTIONS operation on this path. */
  options: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a HEAD operation on this path. */
  head: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
  /** A definition of a TRACE operation on this path. */
  trace: Type.Optional(Type.Union([Type.Ref('Operation'), reference(Type.Ref('Operation'))])),
