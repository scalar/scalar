...
describe("traverseTags", () => {
    ...
    const tagsMap: TagsMap = new Map([
      [
        "default",
        {
          ...
          tag: createMockTag("default"),
          entries: [
            createMockEntry("POST Operation", "post"),
            createMockEntry("GET Operation", "get"),
          ],
        },
      ],
    ]);
  ...
  it("should handle custom tag sorter", () => {
    ...
    const result = traverseTags({
      ...
      tagsMap,
      options: {
        tagsSorter: (a: TagObject, b: TagObject) =>
    ...
    const tagsMap: TagsMap = new Map([
      [
        "default",
        {
          ...
          tag: createMockTag("default"),
          entries: [
            createMockEntry("Operation B", "post"),
            createMockEntry("Operation A", "get"),
          ],
        },
      ],
    ]);
