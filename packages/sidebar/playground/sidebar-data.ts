...
export const galaxySidebar = [
  ...
  },
  {
    ...
    'children': [
      ...
      {
        'id': 'scalar-galaxy/models/credentials',
        'title': 'Credentials',
        'name': 'Credentials',
      ...
      {
        'id': 'scalar-galaxy/models/celestialbody',
        'title': 'CelestialBody',
        'name': 'CelestialBody',
      ...
      {
        'id': 'scalar-galaxy/models/planet',
        'title': 'Planet',
        'name': 'Planet',
      ...
      {
        'id': 'scalar-galaxy/models/satellite',
        'title': 'Satellite',
        'name': 'Satellite',
      ...
      {
        'id': 'scalar-galaxy/models/paginatedresource',
