...
/**
 * The middle slot is optional. When it is present the start and end sections hug
 * their content so the center can grow; when it is absent the start section grows
 * instead. This keeps a wide item (for example a breadcrumb) able to shrink and
 * ellipsize rather than forcing the header past the viewport on narrow screens.
 */
