...
.scalar-input-wrapper-error .scalar-input-label {
  color: var(--scalar-color-error-color, var(--default-scalar-color-red));
}
...
.scalar-input:focus-within:-webkit-autofill:active {
  -webkit-box-shadow: 0 0 0px 1000px
    var(--scalar-background-1, var(--default-scalar-background-1)) inset !important;
  -webkit-text-fill-color: var(--scalar-color-1, var(--default-scalar-color-1));
  color: var(--scalar-color-1, var(--default-scalar-color-1));
...
.scalar-input-wrapper-focus:has(button:active) .scalar-input-label {
  color: var(--scalar-color-3, var(--default-scalar-color-3)) !important;
}
</style>
