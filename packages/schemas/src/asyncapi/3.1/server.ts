...
export const asyncApiServerObject = union(
  [
    ...
    object(
      {
        ...
        variables: optional(
          record(string(), normalRef(asyncApiServerVariableObject), {
  ...
  { typeName: 'AsyncApiServerOrReference' },
)

export const asyncApiServersObject = record(string(), normalRef(asyncApiServerObject), {
