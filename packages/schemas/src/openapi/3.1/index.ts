...
import { WorkspaceManagedExtensions } from './../../extensions/document/workspace-managed-extensions'
import { XInternal } from './../../extensions/document/x-internal'
import { XOriginalOasVersion } from './../../extensions/document/x-original-oas-version'
import { XScalarEnvironments } from './../../extensions/document/x-scalar-environments'
import { XScalarIcon } from './../../extensions/document/x-scalar-icon'
import { XScalarIgnore } from './../../extensions/document/x-scalar-ignore'
import { XScalarIsDirty } from './../../extensions/document/x-scalar-is-dirty'
import { XScalarNavigation } from './../../extensions/document/x-scalar-navigation'
import { XScalarOriginalDocumentHash } from './../../extensions/document/x-scalar-original-document-hash'
import { XScalarRegistryMeta } from './../../extensions/document/x-scalar-registry-meta'
import { XScalarSdkInstallation } from './../../extensions/document/x-scalar-sdk-installation'
import { XScalarWatchMode } from './../../extensions/document/x-scalar-watch-mode'
import { XTags } from './../../extensions/document/x-tags'
import { XDisabled } from './../../extensions/example/x-disabled'
import { XPostResponse } from './../../extensions/general/x-post-response'
import { XPreRequest } from './../../extensions/general/x-pre-request'
import { XScalarActiveEnvironment } from './../../extensions/general/x-scalar-active-environment'
import { XScalarCookies } from './../../extensions/general/x-scalar-cookies'
import { XScalarOrder } from './../../extensions/general/x-scalar-order'
import { XBadges } from './../../extensions/operation/x-badge'
import { XCodeSamples } from './../../extensions/operation/x-code-samples'
import { XDraftExamples } from './../../extensions/operation/x-draft-examples'
import { XScalarDisableParameters } from './../../extensions/operation/x-scalar-disable-parameters'
import { XScalarSelectedContentType } from './../../extensions/operation/x-scalar-selected-content-type'
import { XScalarStability } from './../../extensions/operation/x-scalar-stability'
import { XGlobal } from './../../extensions/parameter/x-global'
import { XAdditionalPropertiesName } from './../../extensions/schema/x-additional-properties-name'
import { XEnumDescriptions } from './../../extensions/schema/x-enum-descriptions'
import { XEnumVarNames } from './../../extensions/schema/x-enum-varnames'
import { XExamples } from './../../extensions/schema/x-examples'
import { XVariable } from './../../extensions/schema/x-variable'
import { XDefaultScopes } from './../../extensions/security/x-default-scopes'
import { XScalarCredentialsLocation } from './../../extensions/security/x-scalar-credentials-location'
import { XScalarSecurityBody } from './../../extensions/security/x-scalar-security-body'
import { XScalarSecurityQuery } from './../../extensions/security/x-scalar-security-query'
import { XScalarAuthUrl, XScalarTokenUrl } from './../../extensions/security/x-scalar-security-secrets'
import { XTokenName } from './../../extensions/security/x-tokenName'
import { XusePkce } from './../../extensions/security/x-use-pkce'
import { XScalarSelectedServer } from './../../extensions/server/x-scalar-selected-server'
import { XDisplayName } from './../../extensions/tag/x-display-name'
import { XTagGroups } from './../../extensions/tag/x-tag-groups'
