import type { SchemaObject } from '@/openapi-types/v3.1/strict/openapi-document'
import type { ParameterObject, ParameterWithContentObject } from '@/openapi-types/v3.1/strict/parameter'
