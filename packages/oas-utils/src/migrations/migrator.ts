...
import { migrate_v_2_6_0 } from '@/migrations/v-2.6.0/migration'
import type { v_2_6_0 } from '@/migrations/v-2.6.0/types.generated'

/** Handles all data migrations per entity */
export const migrator = (): { arrays: v_2_6_0['DataArray']; records: v_2_6_0['DataRecord'] } => {
  ...
  if (semverLessThan(dataVersion, '2.6.0')) {
    data = migrate_v_2_6_0(data)
  }
