import type { ReleaseNotesConfig, ReleaseNotesProduct } from './config/types'

export const SCALAR_RELEASE_NOTES_SCHEMA_PATH = 'tooling/scripts/schemas/RELEASE_NOTES.schema.json'

export const SCALAR_RELEASE_NOTES_PRODUCTS: readonly ReleaseNotesProduct[] = [
  {
    slug: 'api-client',
...
export const scalarReleaseNotesConfig = {
  products: SCALAR_RELEASE_NOTES_PRODUCTS,
  github: {
    repo: 'scalar/scalar',
    baseBranch: 'main',
  },
