...
describe("convertToLocalRef", () => {
  const schemas = new Map([
    ...
    [
      "https://example.com/schema1.json#anchor1",
      "/components/schemas/Schema1/definitions/Anchor1",
    ],
    [
      "https://example.com/schema2.json#anchor2",
      "/components/schemas/Schema2/definitions/Anchor2",
    ],
    [
      "https://example.com/current.json#currentAnchor",
      "/components/schemas/Current/definitions/CurrentAnchor",
    ],
  ]);
  ...
  describe("external references with baseUrl", () => {
    ...
    it("should resolve external reference with JSON pointer path", () => {
      const result = convertToLocalRef(
        "https://example.com/schema1.json#/definitions/User",
        currentContext,
        schemas,
      );
    ...
    it("should return undefined for external reference with unknown anchor", () => {
      const result = convertToLocalRef(
        "https://example.com/schema1.json#unknownAnchor",
        currentContext,
        schemas,
      );
  ...
  describe("complex scenarios", () => {
    it("should handle nested JSON pointer paths", () => {
      ...
      expect(result).toBe(
        "/components/schemas/Schema1/definitions/User/properties/address/properties/street",
      );
    });
  ...
  describe("real-world examples", () => {
    it("should handle OpenAPI component references", () => {
      const openApiSchemas = new Map([
        ...
        [
          "https://api.example.com/schemas/user.json#/properties/id",
          "/components/schemas/User/properties/id",
        ],
        [
          "https://api.example.com/schemas/user.json#userProfile",
          "/components/schemas/User/definitions/UserProfile",
        ],
      ]);
    ...
    it("should handle local component references in OpenAPI", () => {
      const openApiSchemas = new Map([
        [
          "https://api.example.com/openapi.json#userSchema",
          "/components/schemas/User",
        ],
        [
          "https://api.example.com/openapi.json#addressSchema",
