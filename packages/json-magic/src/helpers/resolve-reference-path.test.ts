...
describe("resolveReferencePath", () => {
  describe("remote URLs with relative paths", () => {
    ...
    it("resolves deeply nested relative paths", () => {
      ...
      const result = resolveReferencePath(base, relativePath);
      expect(result).toBe(
        "https://example.com/schemas/entities/user/profile.json",
      );
    });
  ...
  describe("edge cases", () => {
    ...
    it("handles special characters in path", () => {
      ...
      const result = resolveReferencePath(base, relativePath);
      expect(result).toBe(
        "https://example.com/api/schemas/user-profile_v2.json",
      );
    });
    ...
    it("handles base directories", () => {
      const base =
        "/Users/someone/Desktop/Projects/my-project/packages/json-magic/test";
