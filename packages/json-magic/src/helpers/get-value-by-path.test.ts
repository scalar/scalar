...
describe("getValueByPath", () => {
  ...
  it("should handle mixed data types in path", () => {
    ...
    expect(getValueByPath(target, ["string"])).toEqual({
      context: "",
      value: "text",
    });
    expect(getValueByPath(target, ["number"])).toEqual({
      context: "",
      value: 42,
    });
    expect(getValueByPath(target, ["boolean"])).toEqual({
      context: "",
      value: true,
    });
    expect(getValueByPath(target, ["null"])).toEqual({
      context: "",
      value: null,
    });
    expect(getValueByPath(target, ["array"])).toEqual({
      context: "",
      value: [1, 2, 3],
    });
    expect(getValueByPath(target, ["object", "nested"])).toEqual({
      context: "",
      value: "value",
    });
  });
