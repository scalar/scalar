...
<template>
  <div>
    <div class="flex items-center text-sm w-[inherit]">
      <ScalarDropdown>
        <ScalarButton
          class="font-normal h-full justify-start line-clamp-1 py-1.5 px-1.5 text-c-2 hover:bg-b-3 w-fit"
          fullWidth
          variant="ghost">
          <div class="font-normal m-0 text-xs flex gap-1.5 items-center">
