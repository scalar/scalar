    ...
    <template #title>
      <div
        ...
        <input
          v-if="!isReadOnly"
          id="requestname"
          class="text-c-1 rounded pointer-events-auto relative w-full pl-1 -ml-0.5 md:-ml-1 has-[:focus-visible]:outline h-8 group-hover-input has-[:focus-visible]:outline z-10"
