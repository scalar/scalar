...
<template>
  <component
    ...
    "
    class="group-[.alert]:bg-mix-transparent group-[.alert]:bg-mix-amount-95 group-[.alert]:bg-orange group-[.error]:bg-mix-transparent group-[.error]:bg-mix-amount-95 group-[.error]:bg-red"
    role="cell">
    <slot />
  </component>
</template>
