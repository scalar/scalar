...
describe("serializeSimpleStyle", () => {
  ...
  describe("object values", () => {
    ...
    it("handles objects with boolean values", () => {
      expect(
        serializeSimpleStyle({ active: true, visible: false }, false),
      ).toBe("active,true,visible,false");
      expect(serializeSimpleStyle({ active: true, visible: false }, true)).toBe(
        "active=true,visible=false",
      );
    });

    it("handles objects with null values", () => {
      expect(serializeSimpleStyle({ a: null, b: "value" }, false)).toBe(
        "a,null,b,value",
      );
      expect(serializeSimpleStyle({ a: null, b: "value" }, true)).toBe(
        "a=null,b=value",
      );
    });
    ...
    it("handles objects with string values containing special characters", () => {
      ...
      ).toBe("name,John Doe,email,john@example.com");
      expect(
        serializeSimpleStyle(
          { name: "John Doe", email: "john@example.com" },
          true,
...
describe("serializeFormStyle", () => {
  ...
  describe("object values with explode: false", () => {
    ...
    it("handles objects with boolean values", () => {
      expect(serializeFormStyle({ active: true, visible: false }, false)).toBe(
        "active,true,visible,false",
      );
    });

    it("handles objects with null values", () => {
      expect(serializeFormStyle({ a: null, b: "value" }, false)).toBe(
        "a,null,b,value",
      );
    });
  });
  ...
  describe("object values with explode: true", () => {
    ...
    it("handles objects with string values", () => {
      const result = serializeFormStyle(
...
describe("serializeFormStyleForCookies", () => {
  describe("primitive values", () => {
    it("returns string primitives as-is", () => {
      expect(serializeFormStyleForCookies("session123", false)).toBe(
        "session123",
      );
      expect(serializeFormStyleForCookies("session123", true)).toBe(
        "session123",
      );
    });
  ...
  describe("array values with explode: false", () => {
    it("serializes arrays as comma-separated values", () => {
      const value = ["blue", "black", "brown"];
      expect(serializeFormStyleForCookies(value, false)).toBe(
        "blue,black,brown",
      );
    });
    ...
    it("handles arrays with boolean values", () => {
      expect(serializeFormStyleForCookies([true, false], false)).toBe(
        "true,false",
      );
    });
  });
  ...
  describe("object values with explode: false", () => {
    ...
    it("handles objects with mixed nested structures", () => {
      ...
      expect(serializeFormStyleForCookies(value, false)).toBe(
        "name,John,address,city,NYC,zip,10001,active,true",
      );
    });
...
describe("serializeSpaceDelimitedStyle", () => {
  describe("array values", () => {
    ...
    it("handles arrays with values containing spaces", () => {
      expect(serializeSpaceDelimitedStyle(["hello world", "foo bar"])).toBe(
        "hello world foo bar",
      );
    });
  });
  ...
  describe("object values", () => {
    ...
    it("handles single-property objects", () => {
      expect(serializeSpaceDelimitedStyle({ color: "blue" })).toBe(
        "color blue",
      );
    });
    ...
    it("handles objects with boolean values", () => {
      expect(
        serializeSpaceDelimitedStyle({ active: true, visible: false }),
      ).toBe("active true visible false");
    });

    it("handles objects with null values", () => {
      expect(serializeSpaceDelimitedStyle({ a: null, b: "value" })).toBe(
        "a null b value",
      );
    });
  });
...
describe("serializePipeDelimitedStyle", () => {
  ...
  describe("object values", () => {
    ...
    it("handles objects with boolean values", () => {
      expect(
        serializePipeDelimitedStyle({ active: true, visible: false }),
      ).toBe("active|true|visible|false");
    });

    it("handles objects with null values", () => {
      expect(serializePipeDelimitedStyle({ a: null, b: "value" })).toBe(
        "a||b|value",
      );
    });
  });
...
describe("serializeDeepObjectStyle", () => {
  describe("flat objects", () => {
    ...
    it("handles objects with boolean values", () => {
      const result = serializeDeepObjectStyle("flags", {
        active: true,
        visible: false,
      });
      expect(result).toEqual([
  ...
  describe("nested objects", () => {
    ...
    it("handles deeply nested objects", () => {
      ...
      expect(result).toEqual([
        { key: "data[level1][level2][level3]", value: "deep" },
      ]);
    });
  ...
  describe("edge cases", () => {
    ...
    it("handles objects with special characters in keys", () => {
      const result = serializeDeepObjectStyle("data", {
        "user-name": "John",
...
describe("OpenAPI specification compliance", () => {
  ...
  describe("simple style (path and header parameters)", () => {
    ...
    it("matches spec example for object without explode", () => {
      ...
      expect(
        serializeSimpleStyle({ role: "admin", firstName: "Alex" }, false),
    ...
    it("matches spec example for object with explode", () => {
      ...
      expect(
        serializeSimpleStyle({ role: "admin", firstName: "Alex" }, true),
      ).toBe("role=admin,firstName=Alex");
    });
  });
  ...
  describe("form style (query and cookie parameters)", () => {
    ...
    it("matches spec example for object without explode", () => {
      ...
      expect(
        serializeFormStyle({ role: "admin", firstName: "Alex" }, false),
      ).toBe("role,admin,firstName,Alex");
    });
  ...
  describe("spaceDelimited style (query parameters only)", () => {
    ...
    it("matches spec example for object", () => {
      ...
      expect(
        serializeSpaceDelimitedStyle({ role: "admin", firstName: "Alex" }),
      ).toBe("role admin firstName Alex");
    });
  });
  ...
  describe("pipeDelimited style (query parameters only)", () => {
    ...
    it("matches spec example for object", () => {
      ...
      expect(
        serializePipeDelimitedStyle({ role: "admin", firstName: "Alex" }),
      ).toBe("role|admin|firstName|Alex");
    });
  });
  ...
  describe("deepObject style (query parameters only)", () => {
    it("matches spec example for flat object", () => {
      ...
      const result = serializeDeepObjectStyle("id", {
        role: "admin",
        firstName: "Alex",
      });
      expect(result).toEqual([
