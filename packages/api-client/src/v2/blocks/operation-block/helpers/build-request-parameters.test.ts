...
const createParameter = (
  overrides: Partial<ExtendedParameter> &
    Pick<ExtendedParameter, "name" | "in" | "value">,
...
describe("buildRequestParameters", () => {
  ...
  describe("header parameters", () => {
    it("builds header from schema-based parameter", () => {
      const params = [
        createParameter(
          { name: "X-Api-Key", in: "header", value: "my-api-key" },
          { default: { value: "my-api-key" } },
        ),
      ];
      const result = buildRequestParameters(params);
    ...
    it("builds multiple headers", () => {
      const params = [
        createParameter(
          { name: "X-Api-Key", in: "header", value: "key-123" },
          { default: { value: "key-123" } },
        ),
        createParameter(
          { name: "X-Request-Id", in: "header", value: "req-456" },
          { default: { value: "req-456" } },
        ),
        createParameter(
  ...
  describe("query parameters", () => {
    ...
    it("handles duplicate query parameter names", () => {
      const params = [
        createParameter(
          { name: "tag", in: "query", value: "javascript" },
          { default: { value: "javascript" } },
        ),
        createParameter(
          { name: "tag", in: "query", value: "typescript" },
      ...
      expect(result.urlParams.getAll("tag")).toEqual([
        "javascript",
        "typescript",
      ]);
    });
    ...
    it("skips disabled query parameters", () => {
      const params = [
        createParameter(
          { name: "enabled", in: "query", value: "yes" },
          { default: { value: "yes" } },
        ),
        createParameter(
    ...
    it("handles query parameter with special characters", () => {
      const params = [
        createParameter(
          { name: "search", in: "query", value: "hello world" },
    ...
    it("handles query parameter with text/plain content type", () => {
      ...
      expect(result.urlParams.get("description")).toBe(
    ...
    it("handles query parameter with text/xml content type", () => {
      ...
      expect(result.urlParams.get("xmlData")).toBe(
    ...
    it("handles query parameter with application/xml content type", () => {
          ...
          content: {
            "application/xml": {
              ...
              examples: {
                default: {
                  value:
                    '<?xml version="1.0"?><data><field>test</field></data>',
                  "x-disabled": false,
                },
              },
            },
      ...
      expect(result.urlParams.get("payload")).toBe(
        '<?xml version="1.0"?><data><field>test</field></data>',
      );
    });
    ...
    it("handles query parameter with application/x-www-form-urlencoded content type", () => {
      ...
      expect(result.urlParams.get("formData")).toBe(
    ...
    it("handles query parameter with text/html content type", () => {
      ...
      expect(result.urlParams.get("htmlContent")).toBe(
    ...
    it("handles query parameter with array value from named example", () => {
      ...
      expect(result.urlParams.getAll("domains")).toEqual([
        "example.com",
        "example.org",
      ]);
    });
  ...
  describe("cookie parameters", () => {
    it("builds cookie from schema-based parameter", () => {
      const params = [
        createParameter(
          { name: "session_id", in: "cookie", value: "abc123" },
    ...
    it("builds multiple cookies", () => {
      const params = [
        ...
        createParameter(
          { name: "user_pref", in: "cookie", value: "dark-mode" },
          { default: { value: "dark-mode" } },
        ),
        createParameter(
          { name: "tracking_id", in: "cookie", value: "xyz789" },
          { default: { value: "xyz789" } },
        ),
      ];
    ...
    it("skips disabled cookie parameters", () => {
      const params = [
        createParameter(
          { name: "enabled_cookie", in: "cookie", value: "on" },
          { default: { value: "on" } },
        ),
        createParameter(
  ...
  describe("mixed parameter types", () => {
    it("handles parameters of all types together", () => {
      const params = [
        ...
        createParameter(
          { name: "session", in: "cookie", value: "sess123" },
          { default: { value: "sess123" } },
        ),
      ];
  ...
  describe("OpenAPI style variations", () => {
    ...
    describe("form style (default for query and cookie)", () => {
      ...
      it("handles form style with array (explode: true - default)", () => {
        ...
        // Form style with explode: true -> color=blue&color=black&color=brown
        expect(result.urlParams.getAll("color")).toEqual([
          "blue",
          "black",
          "brown",
        ]);
    ...
    describe("object serialization", () => {
      describe("simple style with objects", () => {
        it("handles simple style object with explode: false in header", () => {
          const params = [
            {
              ...
              explode: false,
              examples: {
                default: { value: { role: "admin", firstName: "Alex" } },
              },
            },
          ] satisfies ParameterObject[];
          ...
          expect(result.headers["X-Metadata"]).toBe(
        ...
        it("handles simple style object with explode: false in path", () => {
          ...
          expect(result.pathVariables.id).toBe(
            "role%2Cadmin%2CfirstName%2CAlex",
          );
        });
      });
          ...
          const params = [
            {
              ...
              explode: true,
              examples: {
                default: { value: { limit: 10, active: true, offset: 0 } },
              },
            },
          ] satisfies ParameterObject[];
          ...
          const params = [
            {
              ...
              examples: {
                default: {
                  value: { name: "John", age: null, city: undefined },
                },
              },
            },
          ] satisfies ParameterObject[];
  ...
  describe("environment variable replacement", () => {
    it("replaces env var in parameter value", () => {
      const params = [
        createParameter(
          { name: "X-Api-Key", in: "header", value: "{{apiKey}}" },
  ...
  describe("edge cases", () => {
    ...
    it("headers cast numbers to strings", () => {
      const params = [
        createParameter(
          { name: "X-Count", in: "header", value: "42" },
          { default: { value: 42 } },
        ),
      ];
      const result = buildRequestParameters(params);
    ...
    it("headers cast booleans to strings", () => {
      const params = [
        createParameter(
          { name: "X-Flag", in: "header", value: "true" },
          { default: { value: true } },
        ),
      ];
      const result = buildRequestParameters(params);
    ...
    it("handles parameter names with special characters", () => {
      const params = [
        createParameter(
          {
            name: "X-Special-Header_Name.Test",
            in: "header",
            value: "special",
          },
    ...
    it("handles very long parameter values", () => {
      ...
      const params = [
        createParameter(
          { name: "X-Long", in: "header", value: longValue },
    ...
    it("handles empty string example key", () => {
      const params = [
        createParameter(
          { name: "X-Empty-Key", in: "header", value: "value" },
          { "": { value: "value" } },
        ),
      ];
    ...
    it("preserves order of parameters", () => {
      const params = [
        createParameter(
          { name: "z-header", in: "header", value: "z" },
          { default: { value: "z" } },
        ),
        createParameter(
          { name: "a-header", in: "header", value: "a" },
          { default: { value: "a" } },
        ),
        createParameter(
          { name: "m-header", in: "header", value: "m" },
          { default: { value: "m" } },
        ),
      ];
