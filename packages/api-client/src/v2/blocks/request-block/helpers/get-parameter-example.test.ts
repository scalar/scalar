...
describe('get-example', () => {
  it('returns example from content-based parameter', () => {
    ...
    const result = getParameterExample(param, 'default', 'application/json')
  ...
  it('returns example from schema-based parameter with examples property', () => {
    ...
    const result = getParameterExample(param, 'admin', 'application/json')
  ...
  it('returns null when exampleKey does not exist', () => {
    ...
    const result = getParameterExample(param, 'nonexistent', 'application/json')
  ...
  it('resolves $ref values when example is a reference', () => {
    ...
    const result = getParameterExample(param, 'sample', 'application/json')
