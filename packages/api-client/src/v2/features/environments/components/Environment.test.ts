...
describe("Environment", () => {
  it("renders environment name and color indicator correctly", () => {
    ...
    expect(colorIndicator.attributes("style")).toContain(
  ...
  it("emits edit event when edit button is clicked", async () => {
    ...
    const editButton = iconButtons.find((btn) =>
      btn.props("label")?.includes("Edit"),
    );
  ...
  it("emits delete event when delete button is clicked", async () => {
    ...
    const deleteButton = iconButtons.find((btn) =>
      btn.props("label")?.includes("Delete"),
    );
  ...
  it("passes all required props correctly to EnvironmentVariablesTable", () => {
    ...
    expect(variablesTable.props("environment")).toEqual(
