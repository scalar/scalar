...
describe("useTheme", () => {
  it("returns default theme when store is null", () => {
    ...
    expect(themeStyleTag.value).toContain(
      '<style id="scalar-theme" data-testid="default">',
    );
  ...
  it("uses workspace theme when available", () => {
    ...
    expect(themeStyleTag.value).toContain(
      '<style id="scalar-theme" data-testid="purple">',
    );
  });
  ...
  it("resolves custom theme when provided", () => {
    ...
    expect(themeStyleTag.value).toContain(
      '<style id="scalar-theme" data-testid="my-custom-theme">',
    );
