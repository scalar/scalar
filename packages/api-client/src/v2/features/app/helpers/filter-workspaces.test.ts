...
describe("filterWorkspacesByTeam", () => {
  it("filters workspaces to show only local and current team workspaces", () => {
    const workspaces = [
      ...
      {
        id: "team-a/workspace-2",
        teamUid: "team-a",
        label: "Team A Workspace",
      },
      {
        id: "team-b/workspace-3",
        teamUid: "team-b",
        label: "Team B Workspace",
      },
    ...
    expect(filtered.map((w) => w.id)).toEqual([
      "local/workspace-1",
      "team-a/workspace-2",
      "local/workspace-4",
    ]);
  ...
  it("blocks access to workspaces from multiple other teams", () => {
    const workspaces = [
      ...
      {
        id: "team-a/workspace-1",
        teamUid: "team-a",
        label: "Team A Workspace",
      },
      {
        id: "team-b/workspace-2",
        teamUid: "team-b",
        label: "Team B Workspace",
      },
      {
        id: "team-c/workspace-3",
        teamUid: "team-c",
        label: "Team C Workspace",
      },
      {
        id: "team-a/workspace-4",
        teamUid: "team-a",
        label: "Team A Another Workspace",
      },
    ];
