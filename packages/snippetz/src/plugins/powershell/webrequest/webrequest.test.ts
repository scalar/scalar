...
describe('webrequest', () => {
  it('returns a basic request', () => {
    const result = powershellWebrequest.generate({
      url: 'https://example.com',
    })

    expect(result).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com' -Method 'GET'
$response`)
  })
  ...
  it('returns a POST request', () => {
    ...
    expect(result).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com' -Method 'POST'
$response`)
  })
...
$response = Invoke-WebRequest -Uri 'https://example.com' -Method 'GET' -Headers $headers
$response`)
  })
...
$response = Invoke-WebRequest -Uri 'https://example.com' -Method 'POST' -Headers $headers -Body $body.ToArray()
$body.Dispose()
$response`)
  })
  ...
  it('has query string', () => {
    ...
    expect(result).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com?foo=bar&bar=foo' -Method 'GET'
$response`)
  })
  ...
  it('joins query string parameters with & when the URL already has a query string', () => {
    ...
    expect(result).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com/api?existing=1&foo=bar' -Method 'GET'
$response`)
  })
  ...
  it('quotes a URL whose query string has no other special characters', () => {
    ...
    expect(
      result,
    ).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com/api?param1=value1&param2=value2' -Method 'GET'
$response`)
  })
...
$response = Invoke-WebRequest -Uri 'https://example.com/widget/v1/widgets' -Method 'POST' -Headers $headers -Body $body.ToArray()
$body.Dispose()
$response`)
  })
...
$response`)
  ...
  it('handles special characters in URL', () => {
    ...
    expect(
      result,
    ).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com/path%20with%20spaces/[brackets]' -Method 'GET'
$response`)
  })
  ...
  it('handles special characters in query parameters', () => {
    ...
    expect(
      result,
    ).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com?q=hello%20world%20%26%20more&special=!%40%23%24%25%5E%26*()' -Method 'GET'
$response`)
  })
  ...
  it('handles empty URL', () => {
    ...
    expect(result).toBe(`$response = Invoke-WebRequest -Uri '' -Method 'GET'
$response`)
  })
  ...
  it('handles extremely long URLs', () => {
    ...
    expect(result).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com/${'a'.repeat(2000)}' -Method 'GET'
$response`)
  })
...
$response`)
  ...
  it('handles URLs with dollar sign characters', () => {
    ...
    expect(result).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com/path$with$dollars' -Method 'GET'
$response`)
  })
  ...
  it('handles URLs with dollar signs in query parameters', () => {
    ...
    expect(
      result,
    ).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com?price=%24100&currency=USD%24' -Method 'GET'
$response`)
  })
  ...
  it('handles URLs with dollar signs in path and query', () => {
    ...
    expect(
      result,
    ).toBe(`$response = Invoke-WebRequest -Uri 'https://example.com/api$v1/prices?amount=%2450.00' -Method 'GET'
$response`)
  })
...
$response = Invoke-WebRequest -Uri 'https://editor.scalar.com/test' -Method 'POST' -Headers $headers -Body $body.ToArray()
$body.Dispose()
$response`)
  })
})
