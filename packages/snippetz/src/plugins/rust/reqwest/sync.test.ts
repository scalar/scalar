...
import { rustReqwestSync } from './sync'

describe('rustReqwestSync', () => {
  it('returns a basic request', () => {
    const result = rustReqwestSync.generate({
      url: 'https://example.com',
    })

    expect(result).toBe(`let client = reqwest::blocking::Client::new();
