...
export class HTTPSnippet {
    ...
    this.requests = Promise.all(
      entries.map(({ request }) => {
        ...
        const req = {
          ...
          postData: {
            mimeType:
              ((_a = request.postData) === null || _a === void 0
                ? void 0
                : _a.mimeType) || 'application/octet-stream',
          },
          ...request,
        }
  ...
  async prepare(harRequest) {
    ...
    const cookies =
      (_a = request.cookies) === null || _a === void 0
        ? void 0
        : _a.map(
            ({ name, value }) =>
    ...
    switch (
      (_b = request.postData) === null || _b === void 0 ? void 0 : _b.mimeType
    ) {
      ...
      case 'multipart/alternative':
        ...
        if (
          (_c = request.postData) === null || _c === void 0 ? void 0 : _c.params
        ) {
          ...
          ;(_d = request.postData) === null || _d === void 0
            ? void 0
            : _d.params.forEach((param) => {
      ...
      case 'application/x-www-form-urlencoded':
        if (!request.postData.params) {
          ...
          // always overwrite
          request.postData.text = toSearchParams(
  ...
  async convert(targetId, clientId, options) {
    ...
    const results = (await this.requests).map((request) =>
