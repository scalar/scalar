...
const PACKAGE_CONFIGS: DotNetPackageConfig[] = [
  {
    ...
    enumsDir: '../../../integrations/aspnetcore/src/Scalar.AspNetCore/Enums',
    mapperDir: '../../../integrations/aspnetcore/src/Scalar.AspNetCore/Mapper',
  },
  {
    name: 'aspire',
    namespace: 'Scalar.Aspire',
    enumsDir: '../../../integrations/aspire/src/Scalar.Aspire/Enums',
    mapperDir: '../../../integrations/aspire/src/Scalar.Aspire/Mapper',
  },
]
 ...
 */
function generateScalarTargetEnum(targets: Target[], namespace: string): string {
 ...
 */
function generateScalarClientEnum(
  clients: Array<{ target: string; client: string; title: string }>,
  namespace: string,
): string {
 ...
 */
function generateClientOptionsMapping(targets: Target[], namespace: string): string {
...
function generateForPackage(
  ...
  const clientOptionsMapping = generateClientOptionsMapping(targets, config.namespace)
