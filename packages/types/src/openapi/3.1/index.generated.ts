 ...
 *
 * Generated at: 2026-05-17T04:26:04.234Z
 */
...
export type SchemaObjectProperties = Record<
  string,
  | SchemaObject
  | (ReferenceObject & {
      '$ref-value': SchemaObject
...
export type SchemaObjectAdditionalProperties =
  | boolean
  | (
      | SchemaObject
      | (ReferenceObject & {
...
export type SchemaObjectPatternProperties = Record<
  string,
  | SchemaObject
  | (ReferenceObject & {
      '$ref-value': SchemaObject
