import type { WorkspaceManagedExtensions } from '@scalar/types/extensions/document/workspace-managed-extensions'
import type { XScalarEnvironments } from '@scalar/types/extensions/document/x-scalar-environments'
import type { XScalarIcon } from '@scalar/types/extensions/document/x-scalar-icon'
import type { XScalarIsDirty } from '@scalar/types/extensions/document/x-scalar-is-dirty'
import type { XScalarOriginalDocumentHash } from '@scalar/types/extensions/document/x-scalar-original-document-hash'
import type { XScalarRegistryMeta } from '@scalar/types/extensions/document/x-scalar-registry-meta'
import type { XScalarWatchMode } from '@scalar/types/extensions/document/x-scalar-watch-mode'
...
import type { XScalarActiveEnvironment } from '@scalar/types/extensions/general/x-scalar-active-environment'
import type { XScalarCookies } from '@scalar/types/extensions/general/x-scalar-cookies'
...
import type { XTagGroups } from '@scalar/types/extensions/tag/x-tag-groups'
