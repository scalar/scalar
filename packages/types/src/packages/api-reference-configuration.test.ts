...
describe('ApiReferenceConfigurationSchema', () => {
  ...
  it('validates theme enum values', () => {
    ...
    validThemes.forEach((theme) => {
      expect(() => ApiReferenceConfigurationSchema.parse({ theme })).not.toThrow()
    })
  })
  ...
  it('validates layout enum values', () => {
    ...
    validLayouts.forEach((layout) => {
      expect(() => ApiReferenceConfigurationSchema.parse({ layout })).not.toThrow()
    })
  })
