...
export const HttpSchema = OriginalHttpSchema.merge(SecuritySchemeSchemaExtension).extend({
  ...
  // TODO: Only added to have a default value, but the actual default according to the spec is "bearer"
  /**
   ...
   */
  bearerFormat: z
    .union([z.literal('JWT'), z.literal('bearer'), z.string()])
    .optional()
    .default('JWT'),
})
...
const OAuthValuesSchema = z.object({
  // TODO: Only added to have a default value
  scopes: z.record(z.string(), z.string().optional()).optional().default({}).catch({}).default([]),
 ...
 */
export const OAuthFlowsObjectSchema = OriginalOAuthFlowsObjectSchema.merge(SecuritySchemeSchemaExtension).extend({
  /**
...
const SecurityRequirementObjectSchema = z.record(
  z.string(),
  // TODO: Only added to have a default
  z
    .array(z.string())
    .default([]),
)
