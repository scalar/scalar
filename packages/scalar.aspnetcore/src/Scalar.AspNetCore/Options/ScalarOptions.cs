...
public sealed class ScalarOptions
{
    ...
    /// <remarks>If this property is set, the <see cref="DocumentNames" /> property will be ignored.</remarks>
    public Func<HttpContext, Task<IEnumerable<string>>>? DocumentNamesProvider { get; set; }
