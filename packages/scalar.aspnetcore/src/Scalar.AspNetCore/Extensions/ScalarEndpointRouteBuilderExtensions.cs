...
public static class ScalarEndpointRouteBuilderExtensions
{
    ...
    /// <summary>
    /// Maps the Scalar API reference endpoint. The default endpoint prefix is <c>'/scalar'</c>.
    /// </summary>
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    /// <summary>
    /// Maps the Scalar API reference endpoint with custom options. The default endpoint prefix is <c>'/scalar'</c>.
    /// </summary>
    /// <param name="endpoints">The <see cref="IEndpointRouteBuilder" /> to add the endpoint to.</param>
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    /// <summary>
    /// Maps the Scalar API reference endpoint with custom options and access to the <see cref="HttpContext" />. The default endpoint prefix is <c>'/scalar'</c>.
    /// </summary>
    /// <param name="endpoints">The <see cref="IEndpointRouteBuilder" /> to add the endpoint to.</param>
    ...
    /// <summary>
    /// Maps the Scalar API reference endpoint with a custom endpoint prefix and options, with access to the <see cref="HttpContext" />.
    /// </summary>
    /// <param name="endpoints">The <see cref="IEndpointRouteBuilder" /> to add the endpoint to.</param>
    /// <param name="endpointPrefix">The prefix for the endpoint.</param>
    /// <param name="configureOptions">An action to configure the Scalar options, with access to the <see cref="HttpContext" />.</param>
    public static IEndpointConventionBuilder MapScalarApiReference(this IEndpointRouteBuilder endpoints, [StringSyntax("Route")] string endpointPrefix, Action<ScalarOptions, HttpContext>? configureOptions = null)
    {
        ...
        return scalarEndpointGroup.MapGet("/{documentName?}", async (HttpContext httpContext, IOptionsSnapshot<ScalarOptions> optionsSnapshot, string? documentName) =>
        {
            ...
            var documentUrl = configuration.Urls.First(); // TODO: URLs
