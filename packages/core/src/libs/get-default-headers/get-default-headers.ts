 ...
 * - User-Agent: Added when a userAgent string is provided.
 *
 ...
 * @param userAgent Optional User-Agent header value (e.g., "Scalar/1.0.0")
...
export const getDefaultHeaders = ({
  ...
  // Add User-Agent when provided
  if (userAgent) {
    headers.push(createDefaultHeader('User-Agent', userAgent, existingHeaders))
  }
