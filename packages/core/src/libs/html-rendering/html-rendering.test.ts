  ...
  describe("getConfiguration", () => {
    it("returns configuration object", () => {
      const config = getConfiguration({
        theme: "kepler",
      } as ApiReferenceConfigurationWithSource);
    ...
    it("does not remove content when url is not provided", () => {
      ...
      const config = getConfiguration(
        apiReferenceConfigurationWithSourceSchema.parse({ content }),
      );
    ...
    it("executes content when it is a function", () => {
      ...
      const config = getConfiguration(
        apiReferenceConfigurationWithSourceSchema.parse({ content: contentFn }),
      );
