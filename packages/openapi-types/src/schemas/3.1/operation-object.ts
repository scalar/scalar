...
export const OperationObjectSchema = z.object({
   ...
   */
  // TODO: Cicrcular reference because PathItemObjectSchema imports OperationObjectSchema and
  // OperationObjectSchema imports CallbackObjectSchema
  // 'callbacks': CallbackObjectSchema.optional(),
  /**
