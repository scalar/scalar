    ...
    it("Models with Polymorphism Support", () => {
      const result = ComponentsObjectSchema.parse({
        schemas: {
          ...
          Cat: {
            description:
              "A representation of a cat. Note that `Cat` will be used as the discriminating value.",
            allOf: [
              {
          ...
          Dog: {
            description:
              "A representation of a dog. Note that `Dog` will be used as the discriminating value.",
            allOf: [
              {
                $ref: "#/components/schemas/Pet",
              },
