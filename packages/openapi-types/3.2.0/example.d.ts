 ...
 *
 * @see {@link https://spec.openapis.org/oas/v3.2#example-object}
 */
export type ExampleObject = {
  ...
  description?: string
  /** An example of the data structure that MUST be valid according to the relevant [Schema Object](https://spec.openapis.org/oas/v3.2#schema-object).  If this field is present, `value` MUST be absent. */
  dataValue?: boolean
  /** An example of the serialized form of the value, including encoding and escaping as described under [Validating Examples](https://spec.openapis.org/oas/v3.2#validating-examples).  If `dataValue` is present, then this field SHOULD contain the serialization of the given data.  Otherwise, it SHOULD be the valid serialization of a data value that itself MUST be valid as described for `dataValue`.  This field SHOULD NOT be used if the serialization format is JSON, as the data form is easier to work with. If this field is present, `value`, and `externalValue` MUST be absent. */
