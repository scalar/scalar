 ...
 *
 * @see {@link https://spec.openapis.org/oas/v3.1#link-object}
 */
export type LinkObject = {
  /** A URI reference to an OAS operation. This field is mutually exclusive of the `operationId` field, and MUST point to an [Operation Object](https://spec.openapis.org/oas/v3.1#operation-object). Relative `operationRef` values MAY be used to locate an existing [Operation Object](https://spec.openapis.org/oas/v3.1#operation-object) in the OpenAPI Description. */
  operationRef?: string
  ...
  /** A literal value or [{expression}](https://spec.openapis.org/oas/v3.1#runtime-expressions) to use as a request body when calling the target operation. */
  requestBody?: boolean
