 ...
 *
 * @see {@link https://swagger.io/specification/v2/#parameter-object}
 */
export type QueryParameterSubSchemaObject = {
  /** Determines whether this parameter is mandatory. If the parameter is [`in`](https://swagger.io/specification/v2/#parameterIn) "path", this property is **required** and its value MUST be `true`. Otherwise, the property MAY be included and its default value is `false`. */
  required?: boolean
  ...
  description?: string
  /** **Required.** The name of the parameter. Parameter names are *case sensitive*. <ul><li>If [`in`](https://swagger.io/specification/v2/#parameterIn) is `"path"`, the `name` field MUST correspond to the associated path segment from the [path](https://swagger.io/specification/v2/#pathsPath) field in the [Paths Object](https://swagger.io/specification/v2/#paths-object). See [Path Templating](https://swagger.io/specification/v2/#path-templating) for further information.<li>For all other cases, the `name` corresponds to the parameter name used based on the [`in`](https://swagger.io/specification/v2/#parameterIn) property.</ul> */
  name?: string
