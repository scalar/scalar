 ...
 * @param hashToValue - Map tracking existing hashes and their corresponding values
 ...
 * // Returns something like "2ae91d7"
 */
export async function getSafeHash(value: string, hashToValue: Map<string, string>) {
