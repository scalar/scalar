 ...
 */
export const buildReleaseNotesPreamble = (displayName: string): string => {
  return `# ${displayName} release notes
...
/**
 * Default file preamble for scalar-app release notes. Prefer
 * {@link buildReleaseNotesPreamble} when the product name is known.
 */
export const DEFAULT_RELEASE_NOTES_PREAMBLE = buildReleaseNotesPreamble('Scalar API Client')
