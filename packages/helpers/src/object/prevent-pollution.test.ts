...
describe("preventPollution", () => {
  it("throws when __proto__ is passed", () => {
    expect(() => preventPollution("__proto__")).toThrow(
      'Prototype pollution key detected: "__proto__"',
    );
  });

  it("throws when prototype is passed", () => {
    expect(() => preventPollution("prototype")).toThrow(
      'Prototype pollution key detected: "prototype"',
    );
  });

  it("throws when constructor is passed", () => {
    expect(() => preventPollution("constructor")).toThrow(
      'Prototype pollution key detected: "constructor"',
    );
  });
