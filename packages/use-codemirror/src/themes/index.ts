...
export const customTheme = createTheme({
  ...
  settings: {
    ...
    foreground: 'var(--scalar-color-1, var(--default-scalar-color-1))',
    caret: 'var(--scalar-color-1, var(--default-scalar-color-1))',
    // Selection likely needs a hardcoded color due to it not accepting variables
    selection: 'rgba(151, 183, 205, 0.2)',
    selectionMatch: '#e3dcce',
    gutterBackground:
      'var(--scalar-background-2, var(--default-scalar-background-2))',
    gutterForeground: 'var(--scalar-color-3, var(--default-scalar-color-3))',
    gutterBorder: 'transparent',
    lineHighlight:
      'var(--scalar-background-3, var(--default-scalar-background-3))',
    fontFamily: 'var(--scalar-font-code, var(--default-scalar-font-code))',
  },
  styles: [
    {
      tag: [t.standard(t.tagName), t.tagName],
      color: 'var(--scalar-color-purple, var(--default-scalar-color-purple))',
    },
    {
      tag: [t.comment],
