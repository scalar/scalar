...
import type { ApiReferenceConfiguration, ApiReferenceConfigurationPayload } from '@scalar/types/api-reference'
...
export type ReferenceProps = {
  configuration?: ApiReferenceConfigurationPayload | ReferenceConfiguration
}
