...
describe('OperationsListItem', () => {
  ...
  it('renders operation with path when operation has path property', () => {
    ...
    const wrapper = mount(OperationsListItem, {
      ...
      global: {
        stubs: {
          HttpMethod: {
            template: '<div>{{ method }}</div>',
            props: ['method'],
          },
          ScalarIconWebhooksLogo: {
            template: '<div>WebhookIcon</div>',
          },
          SectionHeaderTag: {
            template: '<div>{{ $slots.default }}</div>',
            props: ['level'],
          },
        },
      },
  ...
  it('shows webhook icon for webhook operations', () => {
    ...
    expect(wrapper.text()).toContain('WebhookIcon')
  })
  ...
  it('does not show webhook icon for regular operations', () => {
    ...
    expect(wrapper.text()).not.toContain('WebhookIcon')
  })
    ...
    const wrapper = mount(OperationsListItem, {
      ...
      global: {
        stubs: {
          ...
          SectionHeaderTag: {
            template: '<div class="sr-only">{{ $slots.default }}</div>',
            props: ['level'],
          },
        },
      },
