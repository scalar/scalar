...
.sidebar-indent-nested :deep(.sidebar-heading) {
  /* prettier-ignore */
  padding-left: calc((var(--scalar-sidebar-level, var(--default-scalar-sidebar-level)) * var(--scalar-sidebar-indent-base, var(--default-scalar-sidebar-indent-base))) + 12px) !important;
}

/* Collapse/expand icons must also be offset */
.sidebar-indent-nested :deep(.sidebar-heading .toggle-nested-icon) {
  /* prettier-ignore */
  left: calc((var(--scalar-sidebar-level, var(--default-scalar-sidebar-level)) * var(--scalar-sidebar-indent-base, var(--default-scalar-sidebar-indent-base))) + 2px) !important;
}
...
:where(.sidebar-indent-nested)
  ...
  /* prettier-ignore */
  color: var(--scalar-sidebar-color-2, var(--default-scalar-sidebar-color-2, var(--scalar-color-2, var(--default-scalar-color-2))));
}
</style>
