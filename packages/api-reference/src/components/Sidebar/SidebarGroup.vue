...
.sidebar-indent-nested :deep(.sidebar-heading) {
  /* prettier-ignore */
  padding-left: calc((var(--sidebar-level, var(--default-sidebar-level)) * var(--scalar-sidebar-indent-base, var(--default-scalar-sidebar-indent-base))) + 12px) !important;
}

/* Collapse/expand icons must also be offset */
.sidebar-indent-nested :deep(.sidebar-heading .toggle-nested-icon) {
  /* prettier-ignore */
  left: calc((var(--sidebar-level, var(--default-sidebar-level)) * var(--scalar-sidebar-indent-base, var(--default-scalar-sidebar-indent-base))) + 2px) !important;
}
...
:where(.sidebar-indent-nested)
  ...
  /* prettier-ignore */
  color: var(--sidebar-color-2, var(--default-sidebar-color-2, var(--scalar-color-2, var(--default-scalar-color-2))));
}
</style>
