      ...
      allOf: [
        {
          ...
          properties: {
            next_page_token: {
              type: "string",
              description:
                "The next page token to paginate through large result sets.",
                              ...
                              allOf: [
                                {
                                  ...
                                  properties: {
                                    id: {
                                      ...
                                      example:
                                        "35497738-9fef-4f8a-97db-0ec34caef065",
                                    },
                                  },
                      ...
                      allOf: [
                        {
                          ...
                          properties: {
                            participant_video_files: {
                              title:
                                "The list of recording files for each participant.",
                              type: "array",
                              description:
                                ...
                                allOf: [
                                  {
                                    ...
                                    properties: {
                                      id: {
                                        ...
                                        example:
                                          "24698bd1-589e-4c33-9ba3-bc788b2a0ac2",
                                      },
                                    },
