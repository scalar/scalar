  ...
  describe("rendering", () => {
    ...
    it("renders with custom renderer", () => {
      const CustomRenderer = {
        name: "CustomRenderer",
        template:
          '<div class="custom-renderer">Rendered with custom renderer</div>',
      ...
      expect(wrapper.find(".custom-renderer").text()).toBe(
      ...
      vi.mocked(usePluginManager).mockReturnValue({
        getViewComponents: vi
          ...
          .mockReturnValue([
            ...
            { component: ReactComponent, renderer: CustomRenderer },
          ]),
        getSpecificationExtensions: vi.fn(),
      });
  ...
  describe("error boundary", () => {
    it("wraps each component in ScalarErrorBoundary", () => {
      ...
      vi.mocked(usePluginManager).mockReturnValue({
        getViewComponents: vi
          .fn()
          .mockReturnValue([{ component: TestComponent }]),
        getSpecificationExtensions: vi.fn(),
      });
    ...
    it("handles component with render function", () => {
      const TestComponent = {
        ...
        render() {
          return h(
            "div",
            { class: "render-function-component" },
            "Render function",
          );
        },
      };
      ...
      expect(wrapper.find(".render-function-component").text()).toBe(
        "Render function",
      );
    });
  });
