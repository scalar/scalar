...
describe("createSearchIndex", () => {
  ...
  describe("tags", () => {
    it("adds a single tag", () => {
      ...
      const tagEntry = index.find(
        (item) => item.type === "tag" && item.title === "Users",
      );
    ...
    it("adds tag without description", () => {
      ...
      const tagEntry = index.find(
        (item) => item.type === "tag" && item.title === "Posts",
      );
      expect(tagEntry).toMatchObject({
        type: "tag",
        title: "Posts",
    ...
    it("adds tag group", () => {
      ...
      const tagGroupEntry = index.find(
        (item) => item.type === "tag" && item.title === "User Management",
      );
  ...
  describe("recursive processing", () => {
    it("processes nested children entries", () => {
      ...
      const operationEntries = index.filter(
