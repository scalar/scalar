...
Pass `quiet: true` to skip those instructions. Diagnostics are not affected: warnings about security schemes the mock server cannot handle, request validator compilation errors, and `x-seed` errors are printed either way.
