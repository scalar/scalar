...
type OpenAPI = ReturnType<typeof convert>
...
describe('getOpenApiFromPostman', () => {
  ...
  it('returns null on JSON parsing errors from convert function', () => {
  ...
  it('returns null on TypeError from convert function', () => {
    const postmanJson = '{"info":{"name":"Test"}}'
  ...
  it('returns null when number is thrown as error', () => {
    const postmanJson = '{"info":{"name":"Test"}}'
  ...
  it('returns null when null is thrown as error', () => {
    const postmanJson = '{"info":{"name":"Test"}}'
  ...
  it('returns null when undefined is thrown as error', () => {
    const postmanJson = '{"info":{"name":"Test"}}'
