...
Scalar generates TypeScript, Python, CLI, Go, Rust, Java, Kotlin, Swift, Ruby, PHP, C#, C++, and Dart. One target is included with every plan and additional targets are $150 per month each, published, and the SDK lives in your repository under your package name — Scalar opens pull requests against it and never cuts tags on your behalf.
