...
[React](https://react.dev/) is one of the most popular libraries for web and native user interfaces.

## Create a new React project (optional)

There are tons of ways to set up a new React project. Here is an easy one using [Vite](https://vitejs.dev/) to get you started:
...
And we’re big TypeScript fans, but let’s just use plain `JavaScript` for the sake of this tutorial:
...
This boots your development server. Open <http://localhost:5173/> to see the beautiful Vite/React example page.
