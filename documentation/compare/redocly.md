...
| Entry paid tier | $150/month flat, 3 seats included | $10 per seat/month, 100-page limit |
...
[Scalar Pro is $150/month flat](https://scalar.com/pricing), with 3 editor seats and unlimited viewer seats included, custom domains, Git sync, Markdown and MDX, hosted MCP servers, and one SDK target. Additional SDK targets are $150/month each. Business at $600/month adds SSO, access groups, and 10 seats; Enterprise adds SAML, RBAC, and full developer portals.
