...
<section class="pricing-agent-context" data-agent-context="pricing">
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>$0</td>
        <td>Beautiful API docs and 1 SDK for APIs up to 25 endpoints. 1 editor seat.</td>
        <td><a href="https://dashboard.scalar.com/register">Get started</a></td>
      </tr>
      <tr>
        <th scope="row">Pro</th>
        <td>$150/month</td>
        <td>Ship docs, SDKs, and MCP servers. 3 editor seats and 1 SDK included, APIs up to 100 endpoints. Volume discounts available.</td>
        <td><a href="https://dashboard.scalar.com/register">Get started</a></td>
      </tr>
      <tr>
        <th scope="row">Business</th>
        <td>$600/month</td>
        <td>SSO and access groups, 10 editor seats, APIs up to 250 endpoints. Volume discounts available.</td>
        <td><a href="https://dashboard.scalar.com/register">Get started</a></td>
      </tr>
      <tr>
  ...
  <ul>
    <li>API size is measured by the number of endpoints in your OpenAPI document. Free covers APIs up to 25 endpoints; Pro includes 100 endpoints; Business includes 250 endpoints; Enterprise is custom.</li>
    ...
    <li>Editor seats: 1 on Free, 3 on Pro, 10 on Business, custom on Enterprise. Additional seats are $50 per seat per month on Pro and Business.</li>
  ...
  <article class="pricing-overview-card pricing-overview-card-pro">
    <div class="pricing-overview-card-content">
      ...
      <ul>
        ...
        <li>
          <scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon>
          1 SDK included, APIs up to 100 endpoints
        </li>
        <li>
          <scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon>
          Hosted MCP servers
  ...
  <article class="pricing-overview-card pricing-overview-card-business">
    <div class="pricing-overview-card-content">
      ...
      <ul>
        ...
        <li>
          <scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon>
          SSO and access groups
        </li>
        <li>
          <scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon>
          1 SDK included, APIs up to 250 endpoints
        </li>
        <li>
          <scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon>
...
<tr class="pricing-table-row pricing-table-group-desc-row"><td class="pricing-table-group-desc" colspan="5">Pricing scales with the size of your API, measured by the number of endpoints in your OpenAPI document.</td></tr>
            <tr class="pricing-table-row">
<th class="pricing-table-column" scope="row">Included API size</th>
...
<td class="pricing-table-column free-price">1</td>
<td class="pricing-table-column pro-price">3</td>
<td class="pricing-table-column business-price">10</td>
<td class="pricing-table-column enterprise-price">Custom</td>
</tr>
            <tr class="pricing-table-row">
<th class="pricing-table-column" scope="row">Additional editor seats</th>
<td class="pricing-table-column free-price"><span class="pricing-table-visually-hidden">Not included</span></td>
<td class="pricing-table-column pro-price">$50 / seat / month</td>
<td class="pricing-table-column business-price">$50 / seat / month</td>
<td class="pricing-table-column enterprise-price">Custom</td>
</tr>
            <tr class="pricing-table-row">
...
<td class="pricing-table-column enterprise-price"><span class="pricing-table-visually-hidden">Included</span><scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon></td>
            ...
            <tr class="pricing-table-row">
<th class="pricing-table-column" scope="row">Guides</th>
<td class="pricing-table-column free-price"><span class="pricing-table-visually-hidden">Not included</span></td>
<td class="pricing-table-column pro-price"><span class="pricing-table-visually-hidden">Included</span><scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon></td>
<td class="pricing-table-column business-price"><span class="pricing-table-visually-hidden">Included</span><scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon></td>
<td class="pricing-table-column enterprise-price"><span class="pricing-table-visually-hidden">Included</span><scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon></td>
            ...
            <tr class="pricing-table-row">
<th class="pricing-table-column" scope="row">Versions</th>
<td class="pricing-table-column free-price"><span class="pricing-table-visually-hidden">Not included</span></td>
<td class="pricing-table-column pro-price"><span class="pricing-table-visually-hidden">Included</span><scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon></td>
<td class="pricing-table-column business-price"><span class="pricing-table-visually-hidden">Included</span><scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon></td>
<td class="pricing-table-column enterprise-price"><span class="pricing-table-visually-hidden">Included</span><scalar-icon src="phosphor/bold/check" aria-hidden="true"></scalar-icon></td>
...
<section class="pricing-faq" aria-label="Pricing FAQ">
  ...
  <div class="pricing-faq-list">
    <details class="pricing-faq-item">
      <summary>How do you measure the size of my API?</summary>
      <p>By the number of endpoints in your OpenAPI document — every method and path pair counts as one endpoint, so <code>GET /planets</code> and <code>POST /planets</code> are two endpoints. Free covers APIs up to 25 endpoints, Pro includes 100, Business includes 250, and Enterprise is sized to your API.</p>
    </details>
    <details class="pricing-faq-item">
      <summary>What happens when my API grows past the included endpoints?</summary>
