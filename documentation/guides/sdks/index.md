...
Every plan includes one SDK target, and pricing scales with the size of your API — measured by the number of endpoints in your OpenAPI document. Additional targets are $150 per month each.

| | Free | Pro | Business | Enterprise |
| --- | --- | --- | --- | --- |
| SDK targets included | 1 | 1 | 1 | Custom |
| Included API size | Up to 25 endpoints | 100 endpoints | 250 endpoints | Custom |
