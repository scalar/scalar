...
| ------ | -------- | ------------ | -------------- |
| [TypeScript](../configuration/typescript.md#publishing) | npm | OIDC | none (OIDC) or `NPM_TOKEN` |
| [Python](../configuration/python.md#publishing) | PyPI | OIDC | none (OIDC) or `PYPI_API_TOKEN` |
| [Go](../configuration/go.md#publishing) | Go modules | Git tag | none |
| [Rust](../configuration/rust.md#publishing) | crates.io | OIDC | none (OIDC) or `CARGO_REGISTRY_TOKEN` |
| [Java and Kotlin](../configuration/java.md#publishing) | Maven Central | Token + GPG | `MAVEN_CENTRAL_USERNAME`, `MAVEN_CENTRAL_PASSWORD`, `MAVEN_GPG_PRIVATE_KEY`, `MAVEN_GPG_PASSPHRASE` |
| [C#](../configuration/csharp.md#publishing) | NuGet | OIDC | `NUGET_USER` (OIDC) or `NUGET_API_KEY` |
| [Ruby](../configuration/ruby.md#publishing) | RubyGems | API key | `RUBYGEMS_API_KEY` |
| [PHP](../configuration/php.md#publishing) | Packagist | Git tag | none |
| [Swift](../configuration/swift.md#publishing) | Swift Package Manager | Git tag | none |
| [Dart](../configuration/dart.md#publishing) | pub.dev | OIDC | none (OIDC) or `PUB_TOKEN` |
| [CLI](../cli.md#publishing) | npm / Homebrew / macOS | OIDC or token | none (npm OIDC) or `NPM_TOKEN`, plus `HOMEBREW_TAP_TOKEN` for Homebrew |
