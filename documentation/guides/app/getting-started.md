...
<div class="flex flex-col gap-3 hero small-test">
  <scalar-heading level="2" slug="scalar-api-client" class="text-balance">
    API Client
  </scalar-heading>
  <p>
...
Install the desktop app for macOS, Windows, or Linux, or open the browser version if you want to try it instantly.

  </scalar-step>

  <scalar-step id="step-2" title="Send your first request">

Enter a URL, choose an HTTP method, and click Send to inspect the response right away.

  </scalar-step>

  <scalar-step id="step-3" title="Import your OpenAPI description">

Drag and drop an OpenAPI file to generate a complete collection with requests, authentication, and documentation.

  </scalar-step>

  <scalar-step id="step-4" title="Keep everything in sync">

When your OpenAPI document changes on disk, API Client can watch for updates and automatically sync your requests and collections.
...
<div class="feature">
  ...
  <div class="flex gap-2 mb-11">
    ...
    <a class="t-editor__button" href="https://client.scalar.com/" target="_blank">Open in Browser</a>
  </div>
  ...
  <div class="resources-cta sticky">
    <div class="resources-cta-container">
      ...
      <p>
        <a class="flex items-center gap-1.5 font-medium text-c-2 hover:bg-b-2 rounded px-2 p-1" href="/products/api-client/download"><scalar-icon src="phosphor/bold/download-simple"></scalar-icon> Download</a>
      </p>
      <p>
      ...
      <p>
        <a class="flex items-center gap-1.5 font-medium text-c-2 hover:bg-b-2 rounded px-2 p-1" href="/products/api-client/community"><scalar-icon src="phosphor/bold/users-three"></scalar-icon> Community</a>
      </p>
      <p class="mt-3 mb-1 pl-2">
        <b class="font-medium">Try it</b>
      </p>
      <p>
        <a class="flex items-center gap-1.5 font-medium text-c-2 hover:bg-b-2 rounded px-2 p-1" href="https://client.scalar.com/" target="_blank"><scalar-icon src="phosphor/bold/arrow-square-out"></scalar-icon> Browser Version</a>
      </p>
    </div>
  </div>
</div>
...
<style>
  ...
  .hero-animation .fa {
    --fa-orange: rgb(252 133 40 / 28%);
    --fa-yellow: #fc8528;
    --fa-red: rgb(252 133 40 / 0%);
    --scalar-background-2: var(--scalar-background-1)
  }
  @supports (color: color(display-p3 1 1 1)) {
    .hero-animation .fa {
        --fa-orange: color(display-p3 0.984314 0.537255 0.172549 / 0.28);
        --fa-yellow: color(display-p3 0.984314 0.537255 0.172549);
        --fa-red: color(display-p3 0.984314 0.537255 0.172549 / 0);
    }
  }
