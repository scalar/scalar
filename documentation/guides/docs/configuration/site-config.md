...
To put your logo in the header, add at least one item to [`navigation.header`](navigation.md#header). If a page hides all three surfaces through its [layout options](navigation.md#layout-options), the logo does not render on that page.
