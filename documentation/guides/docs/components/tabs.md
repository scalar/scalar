...
````html
::::scalar-tabs :::scalar-tab{ title="Overview" } This is the overview tab with
plain text content. You can include **markdown** formatting and other elements.
::: :::scalar-tab{ title="Code Example" } ```bash npm install
@scalar/guide-elements ``` This tab contains a code example with additional
text. ::: :::scalar-tab{ title="Configuration" } ```json { "theme": "dark",
"interactive": true, "features": ["tabs", "steps", "callouts"] } ``` ::: ::::
````
