...
You can [customize](docs/getting-started.md) your login page to your branding if you want, and when you delete the access group changes will be made immediately and access will be revoked.
