...
<a href="https://hub.docker.com/r/scalarapi/mock-server" aria-label="View Scalar Mock Server on Docker Hub"><img alt="Docker Image Version" src="https://img.shields.io/docker/v/scalarapi/mock-server?label=Docker%20image"></a>
<a href="https://hub.docker.com/r/scalarapi/mock-server" aria-label="View Docker pulls for Scalar Mock Server"><img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/scalarapi/mock-server?label=Docker%20pulls"></a>
