    ...
    <div class="company-team-member-image company-team-member-image-marc">
      <div
        ...
        <img
          ...
          src="https://cdn.scalar.com/marketing/landing/marc-sticker.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/marc-sticker.svg"></scalar-icon>
      </div>
    </div>
  ...
  <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-cam">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/cam-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/cam-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
  ...
  <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-hans">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/hans-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/hans-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
  ...
  <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-peter">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/peter-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/peter-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
  ...
  <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-geoff">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/geoff-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/geoff-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
   ...
   <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-amrit">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/amrit-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/amrit-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
  ...
  <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-brynn">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/brynn-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/brynn-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
  ...
  <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-redis">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/redis-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/redis-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
  ...
  <article class="company-team-member">
    <div class="company-team-member-image company-team-member-image-joinus">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/joinus-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/joinus-sticker-final.svg"></scalar-icon>
      </div>
    </div>
    <p class="company-team-member-name">
  ...
  <article class="company-investor-feature">
    <div class="company-investor-logo company-investor-logo-general-catalyst">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/gc-sticker-final.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/gc-sticker-final.svg"></scalar-icon>
      </div>
    </div>
  ...
  <article class="company-investor-feature">
    <div class="company-investor-logo company-investor-logo-kindred">
      <div
        ...
        <img
          class="company-team-sticker-static"
          src="https://cdn.scalar.com/marketing/landing/kindred-final-converted.svg"
          alt=""
          decoding="async"
          loading="lazy" />
        <scalar-icon
          class="company-team-sticker-interactive"
          src="https://cdn.scalar.com/marketing/landing/kindred-final-converted.svg"></scalar-icon>
      </div>
    </div>
    <div class="company-investor-lines">
...
<style>
  ...
  .company-team-member:nth-child(3n + 1) .company-team-member-image {
    border-top-left-radius: var(--scalar-radius);
    border-bottom-left-radius: var(--scalar-radius);
  }
  .company-team-member:nth-child(3n) .company-team-member-image,
  .company-team-member:last-child .company-team-member-image {
    border-top-right-radius: var(--scalar-radius);
    border-bottom-right-radius: var(--scalar-radius);
  }
  .company-team-member-image-brynn {
    --company-team-member-background: #ffdff5;
  }
  .company-team-member-image-marc {
    --company-team-member-background: #ff7fa2;
  }
  .company-team-member-image-cam {
    --company-team-member-background: #feeca2;
  }
  .company-team-member-image-hans {
    --company-team-member-background: #dfc0fb;
  }
  .company-team-member-image-redis {
    --company-team-member-background: #abd0f4;
  }
  .company-team-member-image-geoff {
    --company-team-member-background: #c5daa3;
  }
  .company-team-member-image-peter {
    --company-team-member-background: #ffb5b7;
  }
  ...
  .company-team-section .company-team-member:nth-child(4) .company-team-sticker,
  .company-team-section .company-team-member:nth-child(5) .company-team-sticker,
  .company-team-section .company-team-member:nth-child(7) .company-team-sticker,
  .company-team-section .company-team-member:nth-child(8) .company-team-sticker {
    --sticker-rotate: -7deg;
  }
  .company-team-section .company-team-sticker .sticker-container {
    transform: rotate(var(--sticker-rotate));
    transform-origin: center;
  }
  .company-team-section .company-team-sticker .sticker-lighting svg,
  .company-team-section .company-team-sticker .shadow svg,
  .company-team-section .company-team-sticker .flap svg {
  ...
  .company-team-sticker:active {
    /* --company-sticker-flap-light-height: calc(var(--sticker-peelback-active) + var(--sticker-p)); */
    cursor: grabbing;
  }
  ...
  .company-investor-logo:empty::after {
    display: block;
    width: 36%;
    height: 22px;
    margin: auto;
  ...
  .company-investor-sticker .sticker-main,
  .company-investor-sticker .sticker-lighting,
