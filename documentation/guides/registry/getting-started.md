...
To access Registry, [create an account](https://dashboard.scalar.com/register) or [sign in](https://dashboard.scalar.com/login).
...
<scalar-image
  src="/scalar-dashboard.svg"
  src-dark="/scalar-dashboard-dark.svg"
  alt="Scalar dashboard"
  size="full">
</scalar-image>
