...
The portal maintains its base URL — [developers.partech.com](https://developers.partech.com/) — while offering clearer navigation and removing unnecessary login friction for publicly accessible content. This ensures that developers can reach API documentation quickly and reliably.
...
PAR’s shift to Scalar reflects a strategic investment in open standards, developer productivity, and long-term platform stability. By adopting a technology that fits its existing workflows while enabling modern interaction patterns, PAR has positioned [developers.partech.com](https://developers.partech.com/) as a future-ready hub for API innovation across the organization.
