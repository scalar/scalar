...
<div class="featured-story-copy">
  <p class="featured-story-eyebrow">
    <a
      target="_blank"
      rel="noopener noreferrer nofollow"
      class="featured-story-card"
      href="/customers/partech">
      Featured Story
    </a>
  </p>
  <h2 class="featured-story-title">
    <a
      ...
      class="featured-story-card"
      href="/customers/partech">
      How PAR modernized its developer experience with Scalar
    </a>
  </h2>
  <div class="featured-story-logos" aria-label="PAR and Scalar">
    <scalar-icon
      class="featured-story-logo-par"
      src="https://cdn.scalar.com/marketing/landing/logo-partech.svg?v=2"></scalar-icon>
    <span class="featured-story-logo-separator" aria-hidden="true">
      <a
        target="_blank"
        rel="noopener noreferrer nofollow"
        class="featured-story-card"
    ...
    <p>
      <a
        ...
        href="/customers/partech">
        <scalar-image
          src="/brand/scalar-wordmark-light.svg"
          alt="Scalar"
          class="featured-story-logo-scalar"></scalar-image>
      </a>
    </p>
  </div>
</div>
...
<div class="featured-story-media" aria-hidden="true">
  <p>
    <a
      ...
      class="featured-story-card"
      href="/customers/partech">
      <scalar-image src="/partech-branding.png"></scalar-image>
    </a>
  </p>
</div>
...
<div class="customer-docs-grid">
  <article class="customer-docs-item">
    ...
    <p>
      <a
        target="_blank"
        rel="noreferrer"
        class="customer-docs-link"
        href="https://developer.bobcat.com/">
        View Docs -&gt;
      </a>
    </p>
  </article>
  <article class="customer-docs-item">
    ...
    <p class="customer-docs-copy">
      Provider of software and decision tools for legal and accounting companies
    </p>
    <p>
      <a
        target="_blank"
        rel="noreferrer"
        class="customer-docs-link"
        href="https://developers.thomsonreuters.com/pages/api-reference/19232a0d-5cf9-53a9-a215-efe481550832">
        View Docs -&gt;
      </a>
    </p>
  </article>
  <article class="customer-docs-item">
    ...
    <p class="customer-docs-copy">
      Authentication and User Management platform built for the modern web
    </p>
    <p>
      <a
        target="_blank"
  ...
  <article class="customer-docs-item">
    <div class="customer-docs-image customer-docs-image-later" aria-label="Later">
      <scalar-image src="/later.svg" alt="Later"></scalar-image>
    </div>
    <p class="customer-docs-copy">
      Social media management platform for creators, agencies, and brands
    </p>
  </article>
</div>
