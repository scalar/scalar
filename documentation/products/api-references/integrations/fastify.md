...
await fastify.register(ScalarApiReference, {
  ...
  configuration: {
    ...
    // https://github.com/scalar/scalar/tree/main/documentation/products/api-references/configuration.md
  },
})
```

TypeScript should give you a nice autocomplete for all options. If you're more into reading an actual reference, you can read about all options here: <https://github.com/scalar/scalar/tree/main/documentation/products/api-references/configuration.md>
