...
Beyond having a simpler name, Scalar is also [free to get started with](../guides/pricing.md), and our Pro plan is $150/mo with 5 editor seats included. If you want custom domains, GitHub sync, and a few other features, check out the Pro plan.
